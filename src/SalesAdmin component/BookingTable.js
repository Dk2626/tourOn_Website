...
const BookingTable = ({ bookingDetails, loading1 }) => {
  ...
  let pagesCount = Math.ceil(Object.keys(getBookingByMonth()).length / pageSize)
  // let pagesCount = 10;
        ...
        {loading1 ? (
          ...
          <>
            {getBookingByMonth().length === 0 ? (
              <div className="req-lo">No Details found</div>
            ) : (
              <>
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <h5>{bookingDetails[c].general.salesHandleName}</h5>
                          <h5 className="notifyIcon">
                            ...
                            {getRemindersCount(bookingDetails[c].reminders)[1]
                              .length > 0 && (
